...
import SessionE.SMS.StudentMajorComparator;
import SessionE.SMS.StudentNameComparator;
...
public class ViewStudent {
    ...
    public void execute() {
        ...
        // Print table header
        System.out.format("+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----+%n");
        System.out.format("| %-15s | %-15s | %-15s | %-15s | %-15s | %-15s | %-15s | %-4s |%n", "Type", "ID", "First Name", "Last Name", "Age", "Major", "Email" , "GPA");
        System.out.format("+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----+%n");
